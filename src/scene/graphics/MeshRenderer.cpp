...
class MeshRenderer {
public:
	static void render(Mesh mesh, Vector3 camPos, const bool isSelected, const bool isEditMode) {
...
private:
	static bool isSilhouetteEdge(const Mesh& mesh, const std::vector<int>& faces, const Vector3 camPos) {
